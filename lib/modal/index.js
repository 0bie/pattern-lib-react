  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["title", "content", "rounded", "classNames", "state", "handleClose", "preventClose"]);

      return /*#__PURE__*/React.createElement("div", _extends({}, props, {
        className: "modal-container ".concat(getShape(rounded), " ").concat(addClassNames(classNames), " ").concat(getActiveClassName(state))
