...
var Blockquote = /*#__PURE__*/function (_React$Component) {
  ...
  function Blockquote() {
    ...
    _this.state = {
      quote: truncateQuote(_this.props.quote, _this.props.maxLength, _this.expandQuoteHandler.bind(_assertThisInitialized(_this)))
    };
    return _this;
  }
  ...
  _createClass(Blockquote, [{
    ...
    value: function render() {
      ...
      }, quote)), footer && /*#__PURE__*/React.createElement(BlockquoteFooter, {
        user: user,
        link: link,
        linkCta: linkCta
      }));
