...
export default function Input(_ref) {
  ...
  }, type !== 'textField' && /*#__PURE__*/React.createElement("input", _extends({
    type: type,
    id: inputId,
  ...
  }, props)), type === 'textField' && /*#__PURE__*/React.createElement("textarea", _extends({
    id: inputId,
    placeholder: placeholder,
    pattern: pattern,
    "data-hint": pattern && "".concat(id, "-hint"),
    className: "input input--".concat(size, " ").concat(getShape(rounded), " ").concat(addClassNames(inputClassNames))
  }, props)), icon && /*#__PURE__*/React.createElement(Icon, icon), state === 'error' && /*#__PURE__*/React.createElement(Icon, {
    size: "sm",
    id: "warning",
    classNames: ['icon--error']
  }), state === 'success' && /*#__PURE__*/React.createElement(Icon, {
    size: "sm",
    id: "check",
...
Input.propTypes = {
  ...
  type: PropTypes.oneOf(['text', 'number', 'password', 'textField']),
