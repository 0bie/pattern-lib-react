...
export default function Button(_ref) {
  ...
  }, props), icon && iconPosition === 'left' ? /*#__PURE__*/React.createElement(Icon, icon) : null, label ? /*#__PURE__*/React.createElement("span", {
    className: "btn-text"
  }, label) : loading ? /*#__PURE__*/React.createElement("span", {
    className: "text--sr"
  }, "loading") : icon && !iconPosition ? /*#__PURE__*/React.createElement(Icon, icon) : null, icon && iconPosition === 'right' ? /*#__PURE__*/React.createElement(Icon, icon) : null, children && children);
}
Button.propTypes = {
