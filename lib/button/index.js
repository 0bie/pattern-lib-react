...
export default function Button(_ref) {
  var size = _ref.size,
      ...
      props = _objectWithoutProperties(_ref, ["size", "label", "icon", "rounded", "loading", "classNames", "iconPosition", "type"]);
  ...
  return React.createElement("button", _extends({
    ...
    className: "text--sr"
  }, "loading") : icon && !iconPosition ? React.createElement(Icon, icon) : null, icon && iconPosition === 'right' ? React.createElement(Icon, icon) : null);
}
Button.propTypes = {
