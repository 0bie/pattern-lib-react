...
function (_Component) {
  ...
  function TabSet() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TabSet)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      activeTab: null
    };
  ...
  _createClass(TabSet, [{
    ...
    value: function render() {
      ...
      return React.createElement("nav", props, React.createElement("ul", {
        id: id,
