...
export default function Notice(_ref) {
  var state = _ref.state,
      ...
      props = _objectWithoutProperties(_ref, ["state", "icon", "iconPosition", "message", "rounded", "children", "classNames"]);
  ...
  }, icon && iconPosition === 'left' ? /*#__PURE__*/React.createElement(Icon, icon) : null, /*#__PURE__*/React.createElement("p", null, message && message), icon && iconPosition === 'right' ? /*#__PURE__*/React.createElement(Icon, icon) : null), children && /*#__PURE__*/React.createElement("footer", {
