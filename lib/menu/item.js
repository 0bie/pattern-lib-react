...
export default function MenuItem(_ref) {
  var content = _ref.content,
      icon = _ref.icon,
      handleItem = _ref.handleItem,
      classNames = _ref.classNames,
      props = _objectWithoutProperties(_ref, ["content", "icon", "handleItem", "classNames"]);

  return /*#__PURE__*/React.createElement("li", _extends({
    className: "menu-item ".concat(addClassNames(classNames))
  }, props), icon && /*#__PURE__*/React.createElement(Icon, icon), /*#__PURE__*/React.createElement("a", {
    href: "#",
    onClick: handleItem
  }, content));
}
